...
public class UUIDUtils {
	 ...
	 * @throws Exception
	 */
	public static synchronized String generateRetWoEmptyNo() throws Exception {
		// 生产yyyyMMddHHmmssSSS格式的时间
		String formatDate = DateUtils.getFormatDate(new Date(), DateUtils.FORMAT_NOLINE_YYMMDD);
		return "LYKX" + formatDate + Math.round(Math.random() * 9000L + 1000L);
	}
