-- alter table ret_wo add INSP_TIMESTAMP timestamp(0) null comment "质检申请时间";inWharfChangerTimestamp
...
alter table his_ret_wo add ADD_TYPE int(1) not null comment "添加的类型：0：正常添加，1：码头更换添加，2：质检添加";
...
alter table ret_box_emp_no add APPLY_TIME timestamp(5)  null comment "申请时间";
alter table ret_box_emp_no add APPROVE_TIME timestamp(5) null comment "审核时间";